...
/**
 * Console class with an overview of all scripts that can be runned
 *
...
class Console
{
    ...
    // This is base script which runs all other script (skip this)
    ...
    protected static $config = array(
        ...
        self::FAKING => array(
            'name' => 'faking',
            'description' => 'My great Faking command.',
            'help' => '',
            'interval' => '10',
        ),
    );
